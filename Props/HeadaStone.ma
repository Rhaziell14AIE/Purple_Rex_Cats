...
//Name: Headstones.ma
//Last modified: Tue, Oct 22, 2013 01:45:27 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 549.96459996962039 132.95297381350588 67.222359939574972 ;
	setAttr ".r" -type "double3" -13.199999999990505 -278.80000000002985 5.1974659202236503e-015 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 564.58898151273468;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -0.18099337735346843 1.7640464736623318 -1.4823053579758068 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 6 ".pt";
	setAttr ".pt[120]" -type "float3" 0.13059987 0 -0.53927523 ;
	setAttr ".pt[121]" -type "float3" -0.13059987 0 -0.53927523 ;
	setAttr ".pt[122]" -type "float3" -0.13059987 0 0.53927523 ;
	setAttr ".pt[123]" -type "float3" 0.13059987 0 0.53927523 ;
	setAttr ".dr" 1;
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -0.18099337735346843 1.7640464736623318 13.25802406009576 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" -2.3898924606305911 1.7312849200586857 -22.927435773446753 ;
...
createNode polyTweak -n "polyTweak1";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[8]" -type "float3" 0.11343215 0 -0.25101268 ;
	setAttr ".tk[9]" -type "float3" -0.11343215 0 -0.25101268 ;
	setAttr ".tk[10]" -type "float3" -0.11343215 0 0.25101268 ;
	setAttr ".tk[11]" -type "float3" 0.11343215 0 0.25101268 ;
...
createNode polyTweak -n "polyTweak12";
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[100]" -type "float3" 0 0.2858721 5.9604645e-008 ;
	setAttr ".tk[101]" -type "float3" 0 0.2858721 5.9604645e-008 ;
	setAttr ".tk[102]" -type "float3" 0 -0.2858721 5.9604645e-008 ;
	setAttr ".tk[103]" -type "float3" 0 -0.2858721 5.9604645e-008 ;
	setAttr ".tk[104]" -type "float3" 0 0.2858721 -5.9604645e-008 ;
	setAttr ".tk[105]" -type "float3" 0 0.2858721 -5.9604645e-008 ;
	setAttr ".tk[106]" -type "float3" 0 -0.2858721 -5.9604645e-008 ;
	setAttr ".tk[107]" -type "float3" 0 -0.2858721 -5.9604645e-008 ;
...
createNode polyTweak -n "polyTweak15";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[8]" -type "float3" 0.31096876 0 -0.65295619 ;
	setAttr ".tk[9]" -type "float3" -0.31096876 0 -0.65295619 ;
	setAttr ".tk[10]" -type "float3" -0.31096876 0 0.65295619 ;
	setAttr ".tk[11]" -type "float3" 0.31096876 0 0.65295619 ;
...
createNode polyTweak -n "polyTweak22";
	setAttr ".uopa" yes;
	setAttr -s 17 ".tk";
	setAttr ".tk[178]" -type "float3" 0 1.2150049 1.1920929e-007 ;
	setAttr ".tk[179]" -type "float3" 0 -1.215005 0 ;
	setAttr ".tk[180]" -type "float3" 0 -1.215005 0 ;
	setAttr ".tk[181]" -type "float3" 0 1.2150049 1.1920929e-007 ;
	setAttr ".tk[182]" -type "float3" 0 1.2150049 -1.1920929e-007 ;
	setAttr ".tk[183]" -type "float3" 0 -1.215005 0 ;
	setAttr ".tk[184]" -type "float3" 0 -1.215005 0 ;
	setAttr ".tk[185]" -type "float3" 0 1.2150049 -1.1920929e-007 ;
...
createNode polyTweak -n "polyTweak25";
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[203]" -type "float3" -0.45724583 0 -2.0987968 ;
	setAttr ".tk[204]" -type "float3" 0 3.8146973e-006 0 ;
	setAttr ".tk[205]" -type "float3" 0.45724583 0 2.0987968 ;
	setAttr ".tk[206]" -type "float3" -0.45724583 0 2.0987968 ;
	setAttr ".tk[207]" -type "float3" 0.45724583 0 -2.0987968 ;
...
createNode polyTweak -n "polyTweak26";
	setAttr ".uopa" yes;
	setAttr -s 2 ".tk[203]" -type "float3"  0 1.45344734 0;
