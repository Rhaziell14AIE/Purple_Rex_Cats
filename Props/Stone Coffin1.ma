...
//Last modified: Tue, Oct 15, 2013 01:23:30 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.7194424485481372 11.223093772224953 16.66772543505185 ;
	setAttr ".r" -type "double3" -32.738352729617304 1098.5999999997907 1.6779176473224308e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 19.217793985997105;
...
createNode transform -n "Stone_Coffin1:Group15" -p "Coffin";
	setAttr ".t" -type "double3" 0 1.9337722675797171 0 ;
