...
//Name: Grave tree.ma
//Last modified: Tue, Oct 01, 2013 03:43:26 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.364426688034159 33.018294650543361 193.33242035191245 ;
	setAttr ".r" -type "double3" -8.1383527295274991 -2.6000000000067565 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 213.75996947325879;
...
createNode polyCut -n "polyCut1";
	...
	setAttr ".ro" -type "double3" -93.169717209240645 37.391718487042866 -0.26889867649184174 ;
...
createNode polyCut -n "polyCut2";
	...
	setAttr ".ro" -type "double3" -94.808591720933364 37.331446018403028 -1.832630154523569 ;
	setAttr ".ps" -type "double2" 6.3513453006744385 25.928045272827148 ;
...
createNode polyCut -n "polyCut11";
	...
	setAttr ".ro" -type "double3" -133.54097091115028 0.43307981169602056 -54.154174119017497 ;
...
createNode polyCut -n "polyCut15";
	...
	setAttr ".ro" -type "double3" -40.465944478253796 -0.6482573023880539 126.07868484283026 ;
...
createNode polyCut -n "polyCut16";
	...
	setAttr ".ro" -type "double3" -109.19023679436074 42.742757971928853 35.936120801674804 ;
...
createNode polyTweak -n "polyTweak6";
	setAttr ".uopa" yes;
	setAttr -s 11 ".tk";
	setAttr ".tk[50]" -type "float3" 0.55086112 0 -0.73294985 ;
	setAttr ".tk[51]" -type "float3" 0.27543104 0 -0.73294985 ;
	setAttr ".tk[52]" -type "float3" 0.27543104 0 0.73294985 ;
	setAttr ".tk[53]" -type "float3" 0.55086112 0 0.73294985 ;
	setAttr ".tk[54]" -type "float3" -1.7296748e-015 0 -0.73294985 ;
	setAttr ".tk[55]" -type "float3" -1.7296748e-015 0 0.73294985 ;
	setAttr ".tk[56]" -type "float3" -0.27543104 0 -0.73294985 ;
	setAttr ".tk[57]" -type "float3" -0.27543104 0 0.73294985 ;
	setAttr ".tk[58]" -type "float3" -0.55086112 0 -0.73294985 ;
	setAttr ".tk[59]" -type "float3" -0.55086112 0 0.73294985 ;
...
createNode polyCut -n "polyCut18";
	...
	setAttr ".ro" -type "double3" 64.039797358908743 -37.919263984552288 -170.7962291010825 ;
	setAttr ".ps" -type "double2" 2.0622482299804687 20.251028060913086 ;
...
createNode polyCut -n "polyCut21";
	...
	setAttr ".ro" -type "double3" -53.563468115592975 -12.369221234006464 -160.84010573798702 ;
...
createNode polyTweak -n "polyTweak18";
	setAttr ".uopa" yes;
	setAttr -s 22 ".tk";
	setAttr ".tk[221]" -type "float3" -1.6914659 1.9992059 -0.014577247 ;
	setAttr ".tk[222]" -type "float3" -1.692976 1.9866307 -0.02821169 ;
	setAttr ".tk[223]" -type "float3" -1.6875061 2.0146577 -0.00052986294 ;
	setAttr ".tk[224]" -type "float3" -1.6803719 2.0330513 0.013085134 ;
	setAttr ".tk[225]" -type "float3" -1.6693172 2.0532568 0.023927309 ;
	setAttr ".tk[226]" -type "float3" -1.6542956 2.0723114 0.028243296 ;
	setAttr ".tk[227]" -type "float3" -1.6368006 2.0857229 0.022408672 ;
	setAttr ".tk[228]" -type "float3" -1.6200055 2.0898719 0.0059986189 ;
	setAttr ".tk[229]" -type "float3" -1.6073241 2.0852294 -0.016016342 ;
	setAttr ".tk[230]" -type "float3" -1.6004764 2.0762775 -0.035877325 ;
	setAttr ".tk[231]" -type "float3" -1.5993268 2.064568 -0.051846988 ;
	setAttr ".tk[232]" -type "float3" -1.6038431 2.0454552 -0.069716461 ;
	setAttr ".tk[233]" -type "float3" -1.6147085 2.0180454 -0.089712657 ;
	setAttr ".tk[234]" -type "float3" -1.6309651 1.9898106 -0.10381261 ;
	setAttr ".tk[235]" -type "float3" -1.6490333 1.9689715 -0.10643605 ;
	setAttr ".tk[236]" -type "float3" -1.665013 1.9586605 -0.098704256 ;
	setAttr ".tk[237]" -type "float3" -1.6769646 1.957119 -0.085283078 ;
	setAttr ".tk[238]" -type "float3" -1.6849691 1.9609894 -0.070219405 ;
	setAttr ".tk[239]" -type "float3" -1.6898857 1.9677733 -0.055517681 ;
	setAttr ".tk[240]" -type "float3" -1.6924384 1.9763359 -0.041644908 ;
select -ne :time1;
	setAttr ".o" 11;
	setAttr ".unw" 11;
